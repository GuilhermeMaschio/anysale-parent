...
| Catalog Service (`8082`) | `SPRING_DATA_MONGODB_URI`, `SPRING_KAFKA_BOOTSTRAP_SERVERS`, `SPRING_KAFKA_CONSUMER_GROUP_ID`, `SPRING_KAFKA_CONSUMER_AUTO_OFFSET_RESET`, `LEAD_SERVICE_BASE_URL` | `KEYCLOAK_ISSUER` ao executar com o perfil `dev-keycloak` |
